Appendix 1: Activity 1 Source Code
#include <iostream>
...
void function1(int number)
{
	...
	std::cout << "In 'function1', the value equals to " << number << std::endl;
	/* C9. display the address of number to the screen */
	std::cout << "In 'function1', the address of 'number' equals to " << &number << std::endl;
...
void function2(int* numberPtr)
{
	...
	std::cout << "In 'function2', the address of 'number' equals to " << numberPtr << std::endl;
	...
	*numberPtr += 1;
	...
	std::cout << "In 'function2', the value of 'number' now equals to " << *numberPtr << std::endl;
}